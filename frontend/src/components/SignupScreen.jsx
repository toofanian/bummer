      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        ...
        <form onSubmit={handleGoogleSignIn} className="flex flex-col items-center gap-4">
          ...
          <button type="submit" disabled={loading}
            className="flex items-center gap-3 bg-black text-white font-medium text-sm px-5 py-2.5 rounded-lg border border-[#333] transition-all duration-200 hover:bg-[#191919] hover:border-[#555] disabled:opacity-50"
