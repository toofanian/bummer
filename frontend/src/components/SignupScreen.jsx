      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        ...
        <form onSubmit={handleGoogleSignIn} className="flex flex-col items-center gap-4">
          ...
          <button type="submit" disabled={loading}
            className="flex items-center gap-3 bg-white text-[#1f1f1f] font-medium text-sm px-6 py-2.5 rounded-full border border-[#dadce0] shadow-sm transition-all duration-200 hover:shadow-md hover:border-[#c6c6c6] active:bg-[#f1f1f1] disabled:opacity-50"
